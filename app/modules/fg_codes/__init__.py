...
def _apply_calculation_results(tw, results, key_variables, calibration):
    ...
    tw.stage1_pacifying_nicotine_demand = interim.get('nic_demand_stage1')
    tw.stage2_pacifying_nicotine_demand = interim.get('nic_demand_stage2')
    tw.total_pacifying_nicotine_demand = interim.get('nic_demand_total')
    tw.total_nicotine_demand = interim.get('nicotine_filtration_pct')
    tw.total_filtration_pct = interim.get('total_nicotine')
